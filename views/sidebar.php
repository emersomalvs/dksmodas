<aside>
	...
	<div class="filterarea">
		...
		<form method="GET">
			...
			<div class="filterbox">
				<div class="filtertitle">Cores</div>
				<div class="filtercontent">
					<?php foreach($viewData['filters']['brands'] as $bitem): ?>
					<div class="filter-box-div <?php echo $bitem['name']; ?>">
						<input class="input-box" type="checkbox" <?php echo (isset($viewData['filters_selected']['brand']) && in_array($bitem['id'], $viewData['filters_selected']['brand']))?'checked="checked"':''; ?> name="filter[brand][]" value="<?php echo $bitem['id']; ?>" id="filter_brand<?php echo $bitem['id']; ?>" /> 
						<label for="filter_brand<?php echo $bitem['id']; ?>"></label>
					</div>
					<?php endforeach; ?>
				</div>
			</div>
