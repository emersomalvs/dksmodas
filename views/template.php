						...
						<a href="<?php echo BASE_URL; ?>login">
							<div class="logado">
								...
								<div class="logadonicon">
									...
									<span><b>login ou<br>cadastre-se</b></span>
								</div>
							</div>
						</a>
					</div>
...
?>
  ...
  <ol>
		...
		<div class="container">
			...
			<li class="menu_subcategory"><i class="fas fa-angle-right"></i><a href="<?php echo BASE_URL; ?>categories/enter/<?php echo $cf['id']; ?>"><?php echo $cf['name']; ?></a></li>
			<?php endforeach; ?>
			<?php endif; ?>
